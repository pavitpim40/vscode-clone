...
describe('readFiles', () => {
  ...
  it('should read two files', async () => {
    const userFiles = [
      { id: '1', name: 'index.js', code: "console.log('hello world')", extension: 'js', relativePath: 'src/main.js' },
      { id: '2', name: 'index.css', code: 'body { background: red; }', extension: 'css', relativePath: 'src/main.css' },
    ];
